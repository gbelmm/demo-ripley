...
export class TransfersService {
    ...
    constructor(
      private mailgunService:MailgunService,
        @InjectModel(Transfers.name) private readonly transfersModel: Model<Transfers>,
      ) {}
      ...
      async  sendEmail(email,amount) {
        ...
        const options:any = {
            ...
            text: 'Ha recibido una nueva tranferencia por un monto de <b>'+amount+'<b>' ,
            html: 'Ha recibido una nueva tranferencia por un monto de <b>'+amount+'<b>'  
          };
